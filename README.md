This was a Solo Project displaying 2 Input & 1 Text Area to render a paragraph below. Information stored in Firebase using a real-time Database to push and remove data from the app
